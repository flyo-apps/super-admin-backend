...
class ProductsSchema(Base):
    ...
    estimated_delivery_text = Column(String)
    complete_the_look = Column(ARRAY(String))
    finest_quality = Column(ARRAY(String))
    craftsmanship = Column(String)
    testimonial = Column(ARRAY(String))
    why_we_stand_out = Column(ARRAY(JSON))
    faqs = Column(ARRAY(JSON))
    length = Column(Float)
    width = Column(Float)
    breadth = Column(Float)
    length_unit = Column(String)
    width_unit = Column(String)
    breadth_unit = Column(String)
